/**
 * Voice Recorder Module - Independent & Auto-Inject
 */
const VoiceRecorder = (() => {
    ...
    style.textContent = `
        ...
        .vr-del { color: #94a3b8; border: none; background: none; cursor: pointer; font-size: 18px; padding: 0 5px; line-height: 1; }
    ...
    function stopRec() {
        if (mediaRecorder && mediaRecorder.state !== "inactive") {
            ...
            document.getElementById('vr-status').innerText = "⌛ Đang nạp...";
        }
    }
    ...
    function uploadFile() {
        ...
        reader.onloadend = async () => {
            ...
            document.getElementById('vr-status').innerText = "✅ Xong";
    ...
    async function loadList() {
        ...
        try {
            ...
            // QUAN TRỌNG: Không dùng crossorigin="anonymous" để tránh lỗi CORS của Google
