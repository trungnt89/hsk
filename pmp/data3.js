var DATA_SET_3 =[
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "To promote communication between the two sites, the project manager should schedule online meetings during the overlapping hours. This will ensure that team members from both sites can participate in the meetings and communicate effectively. This can help to avoid misunderstandings and delays, and ultimately lead to a successful project outcome.\nThe other options are incorrect.\nPraising team members who are available after hours can lead to burnout, resentment, and low morale.\nAsking team members to adhere to uniform working hours may not be feasible or realistic. \nDrafting a team charter to establish a decision-making method is a good idea, but does not directly promote communication between the two teams.\nThe Project Management Tool Kit: 100 Tips and Techniques for Getting the Job Done Right (No Date) /Amazon/13/99 [Item Teamwork Process ]"
  },
  {
    "id": "3 of 175",
    "question": "An ongoing project has a high degree of change. In order to evaluate how the new IT security team will influence the performance of the project, what should the project manager do?",
    "options": {
  ...
  {
    "id": "5 of 175",
    "question": "A project manager has developed a project management plan based on agile methodologies in an effort to deliver the product quickly. However, the project is complex and the requirements are unclear, putting the schedule at risk.\nWhat should the project manager do to get the project back on track?",
    "options": {
  ...
  {
    "id": "10 of 175",
    "question": "A project manager is developing a project budget. After estimating the cost of each activity, the manager adds a contingency reserve by increasing the estimated cost of all activities by the same percentage. However, this resulted in the total cost exceeding the allocated budget even before adding the management reserve.",
    "options": {
  ...
  {
    "id": "23 of 175",
    "question": "A project is close to completion, and the customer wants to celebrate the success by sharing a business case about the benefits created by the project. The project manager and team feel apprehensive about sharing a business case at this stage.\nWhat is the most appropriate action for the project manager to take?",
    "options": {
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "Subject matter experts are invited to the meeting because they provide functional expertise that will help to quickly identify high-risk areas. Expert judgment is the contribution provided to risk identification based on expertise in a subject area, industry segment, organizational processes, etc.\nThe other answer choices are incorrect because the meeting was called to identify risks, not what may happen after the risk has been identified. When subject matter experts assist in identifying risks, they do not typically provide resources beyond their expertise. The participation of subject matter experts does not necessarily make risks easier to accept nor does it ensure that better resources will be secured.\n| Project management: A Systems Approach to Planning, Scheduling, and Controlling (2009) Harold Kerzner/John Wiley/4.10/Location 5980 [Item]"
  },
  {
    "id": "47 of 175",
    "question": "A project manager has just taken over an ongoing project. The previous project manager resigned from the organization. During a review of the project documentation, the project manager realizes there are major deviations in the procurement process used by the previous project manager to engage service providers currently working on the project.",
    "options": {
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "The project manager should first review the new compliance requirement and assess its impact on project tasks and deliverables. This will help the project manager understand the changes that need to be made to ensure compliance and make effective decisions and plans. \nIt is important to evaluate the impact before making any decisions or updates to the project schedule, budget, or risk register. Proceeding with the project without a thorough evaluation could lead to negative consequences and project failure.\nPMBOK Guide – Seventh Edition (2021) PMI /// [2.4 PLANNING PERFORMANCE DOMAIN] [2.5.7 MONITORING NEW WORK AND CHANGES]"
  },
  {
    "id": "50 of 175",
    "question": "A project manager for a delivery project has engaged a vendor to provide testing services. Which items should the project manager be sure to provide to the vendor before the testing starts?",
    "options": {
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "The best option is to encourage regular meetings where all parties can connect and develop a sense of collaboration. The other options are not the most efficient way to operate and may not promote collaboration.\nO'Reilly Platform (No Date) //Logistics/ [Item Managing Virtual Teams]\n| PMBOK Guide Sixth Edition (2018) PMI/PMI/10.2/365 [Item]\n| The Agile Practice Guide (No Date) PMI/PMI/4.3.6/46 [Item]"
  },
  {
    "id": "55 of 175",
    "question": "A new project manager is hired to replace a project manager who was recently transferred to another project. The team members tell the new project manager that the project is behind schedule due to delays in document approvals from the customer.",
    "options": {
  ...
  },
  {
    ...
    "answer": "D",
    "explanation": "To detect that the benefits are achieved, there must be a metric monitoring in order to make sure that the benefits are being accomplished during the project life cycle.\nMastering Project Time Management, Cost Control, and Quality Management (No Date) Randal Wilson//9/ [Item Ensure that project vision, goals, objectives, and benefits are clear to all stakeholders.]\n| PMBOK Guide Sixth Edition (2018) PMI/PMI/1.2.6.2/33 [Item]"
  },
  {
    "id": "61 of 175",
    "question": "After nine months, a project concludes its first phase with the release of a new product to the customer. The client is dissatisfied and states that many key features are missing.\nWhat should the project manager do first in order to address this issue?",
    "options": {
  ...
  },
  {
    ...
    "answer": "B",
    "explanation": "The project manager should first assess the impact of requirements not being met, and then decide on a course of action. It is too soon to notify management or call a stakeholder meeting; the impacts need to be assessed first, before \"sounding the alarm.\" Likewise, the impact analysis would be an input into updating the risk register.\nO'Reilly Platform (No Date) //Effective Project Management, 8th Edition Author : Robert K. Wysocki/Chapter 5: What are Project Management Process Groups [Item https://learning.oreilly.com/library/view/effective-project-management/9781119562801/c05.xhtml\nheading: Monitoring Requirement Change Requests]\n| PMBOK Guide Sixth Edition (2018) PMI/PMI/11/449 [Item]"
  },
  {
    "id": "68 of 175",
    "question": "The project manager of a large team notices team members are not interacting together, which is impacting project performance and the quality of the project outcome. What should the project manager do to help grow team dynamics?",
    "options": {
  ...
  {
    "id": "84 of 175",
    "question": "During a hybrid project, a project manager reviews the project team's performance and realizes that the team's velocity is not fast enough to meet the next review gate goal. What should the project manager do?",
    "options": {
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "The project manager should create a risk item in the risk register and incorporate the thresholds according to the benchmarks. Risk register updates are the most critical; the other actions listed are less useful for risk mitigation.\nAgile Estimating and Planning (No Date) Mike Cohn//17/190 [Item]\n| PMBOK Guide Sixth Edition (2018) PMI/PMI/11 - Section 11.2.3 -Risk Register/417 [Item]\n| Practice Standard for Project Risk Management (2009) Project Management Institute/Project Management Institute// [Item project risk analysis]"
  },
  {
    "id": "86 of 175",
    "question": "A project manager in the execution phase of a project discovers several stakeholders identified at project initiation are no longer involved. These removed stakeholders are frustrated with unnecessary communication and express concern that the remaining stakeholders may not be receiving all of the information they require.\nWhat should the project manager have done to prevent this situation?",
    "options": {
  ...
  {
    "id": "89 of 175",
    "question": "A project manager used to work on predictive projects and now has started working on a project using a hybrid approach. What should the project manager do to enable the teams to focus on their mission?",
    "options": {
    ...
    "answer": "B",
    "explanation": "Servant leadership is the practice of leading the team by focusing on understanding and addressing the needs and development of team members to enable the highest possible team performance. \nThe other options may not directly address the transition from predictive to hybrid methods and creating an environment where the team can focus on their mission.\nChoose Your WoW! A Disciplined Agile Delivery Handbook for Optimizing Your Way of Working (January 2019) Scott W Ambler and Mark Lines//27/382 [Item]\nPMBOK Guide Seventh Edition (2022) /// [2.2.1 PROJECT TEAM MANAGEMENT AND LEADERSHIP]"
  },
  {
    "id": "90 of 175",
    "question": "A project manager working in an agile environment realizes that some new team members are having difficulty understanding how more senior team members accomplished certain results on the project.",
    "options": {
  ...
  {
    "id": "112 of 175",
    "question": "A key resource approaches the project manager after the kick-off meeting and expresses concern that they will be unable to deliver their assigned tasks due to other priorities.",
    "options": {
  ...
  {
    "id": "115 of 175",
    "question": "A team member who is unfamiliar with the subject matter is struggling to complete a complex deliverable. What should the agile project manager do to ensure that the team member is able to take on a similar challenge in the future?",
    "options": {
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "Initiating a formal change request is correct because using an off-the-shelf, open-source product would require a change to the project plan. By initiating a formal change request, the project manager can ensure that the proposed change is carefully considered and that all stakeholders are aware of the potential impact. This will help to minimize disruption to the project and ensure that the change is implemented successfully.\nThe other options are incorrect because the project manager should not make any changes to the project plan without first initiating a change request.\nReviewing the cost management plan and/or requesting training for the project team may be necessary, but it should not be done until the change request has been approved.\nConsulting the product manager may be useful for gathering information, but it is not a substitute for the formal change request process, which ensures that changes are managed systematically and transparently within the project."
  },
  {
    "id": "122 of 175",
    "question": "A project manager is leading a project to implement a process improvement software system that was developed in-house. However, the adoption across the organization was less than 50% due to a misalignment with core processes.\nWhich three of the following actions should the project manager have performed to realize the project benefits? (Choose 3)",
    "options": {
  ...
  {
    "id": "126 of 175",
    "question": "A senior team member was very influential and played a crucial role in past projects. In this new project, the senior member no longer plays a crucial role and is demotivated.",
    "options": {
  ...
  {
    "id": "133 of 175",
    "question": "A senior stakeholder was invited to a sprint review meeting and asked a project team member to describe the final product that the project will deliver. The team member was unable to respond and deferred the question to a more senior member of the team.\nWhat should have been done differently in this situation?",
    "options": {
  ...
  {
    "id": "150 of 175",
    "question": "A project manager is newly assigned to an ongoing project and determines that the quality has been consistent. There is a considerable budget for quality assurance, and other areas of the project could benefit from these funds.",
    "options": {
    ...
    "answer": "D",
    "explanation": "The project manager is new to the project, so it is crucial that they take time to familiarize themselves with the existing quality assurance process and the project's specific quality needs and challenges. Project quality has been consistent, and reducing the budget at this time could jeopardize the overall quality of the project. Quality assurance efforts focus on finding quality issues as soon as possible because discovering quality issues late in development would have substantial implications and could result in project failure.\nReducing or reallocating the existing quality assurance budget is premature and could lead to quality issues.\nA full inspection is time-consuming, expensive, and unnecessary if the project manager has no reason to believe there is a problem with the quality of the project. \nSampling is inconsistent and introducing it without a thorough evaluation and planning could be risky. \nPMBOK Guide Seventh Edition (2022) /// [2.6 DELIVERY PERFORMANCE DOMAIN]"
  },
  {
    "id": "151 of 175",
    "question": "A project manager is assigned to a mobile application development project. The project manager realizes that an agile approach is better suited for the project, but most of the team is not experienced in agile approaches.\nWhat should the project manager do next if the organization is open to using an agile approach?",
    "options": {
