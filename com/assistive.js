    ...
    function initAssistiveTouch() {
        ...
        menu.innerHTML = `<div class="menu-container">
            ...
            <div class="menu-grid">
                ...
                <a class="menu-item" href="https://hsk-gilt.vercel.app/link.html" onclick="console.log('[Navigation] Click: Links')"><div class="item-icon">🔗</div><span class="item-label">Links</span></a>
