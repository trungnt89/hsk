var DATA_SET_2 = [
  {
    "id": "1 of 175",
    "question": "The night before a standup meeting, a project manager realizes that they will be unable to attend the daily standup meeting in person but will join via phone. The project manager sent an email to the project team letting them know. One of the team members is upset that, despite having the longest commute, they are expected to attend the meeting in person.\nHow should the project manager address this situation?",
    "options": {
  ...
  },
  {
    ...
    "options": {
      "A": "Servant leadership -- phục vụ -->giảm cản trở",
      "B": "Transactional leadership",
      "C": "Directive leadership",
      "D": "Constructive leadership -- cái tiến, xây dựng --> giúp phát triển hơn"
    },
    "answer": "A",
  ...
  {
    "id": "12 of 175",
    "question": "In order to reduce procurement time during a bidding process, a project manager decided to contract the additional work to a current contractor. The other bidders are complaining about this decision because they think that the process lacked transparency and fairness.\nWhat should the project manager have done to prevent this?",
    "options": {
  ...
  {
    "id": "16 of 175",
    "question": "During a standup meeting, the project manager discovers that one of the software developers is struggling to complete work because they lack experience with automation testing, potentially affecting the sprint goal. A quality assurance engineer on the team has automation testing experience but is busy preparing a presentation for new employees.\nWhat action would increase the chances of achieving the sprint goal?",
    "options": {
  ...
  {
    "id": "22 of 175",
    "question": "During project implementation, a stakeholder is questioning the purpose of the project and wants to pause the project to assess a new process that may affect the final deliverable.\nWhat is one of the first things the project manager should do?",
    "options": {
  ...
  {
    "id": "27 of 175",
    "question": "While gathering requirements for the project scope, the project manager realizes that some of the stakeholder requirements have a conflict.\nWhat should the project manager do to define a clear scope?",
    "options": {
    ...
    "answer": "A",
    "explanation": "The project manager has to be proactive to reach a consensus between the project team and stakeholders. All parties should be involved so that a consensus can be reached. The project manager must use all necessary communication techniques to gather and ensure requirements are clear.\nThe other options are incorrect. They do not involve all parties to resolve the conflict.\nEffective Project Management: Traditional, Agile, Extreme, Hybrid (No Date) Robert K. Wysocki//2/ [Item What is project management? ]\n| PMBOK Guide Sixth Edition (2018) PMI/PMI/13.3.2.2/527 [Item]"
  },
  {
    "id": "28 of 175",
    "question": "The project manager needs to survey the necessary parties to reach a consensus and build a common vision for the project. To achieve better results, who should be engaged in the development of a common vision strategy?",
    "options": {
  ...
  {
    "id": "32 of 175",
    "question": "An organization is adopting an agile approach to fulfill its customer's requirements. Prior to that, the organization worked with specialized resources and project managers who were assigned to the project for a fixed amount of time.\nWhat should the organization change to better adopt the agile approach for resource planning?",
    "options": {
  ...
  {
    "id": "37 of 175",
    "question": "During the last five daily standups, one team member on a hybrid (predictive-agile) project has been vague about what they have accomplished and what they are planning to accomplish.",
    "options": {
  ...
  {
    "id": "41 of 175",
    "question": "A customer has rejected an interim project deliverable. What should the project manager do?",
    "options": {
  ...
  },
  {
    ...
    "answer": "D",
    "explanation": "The project manager should conduct periodic reviews with the customer. During the whole project, there was no real user involvement and input on the product being created. Although the team was performing well, they were not creating the 'right' product to satisfy customers.\nThe other answer choices are incorrect. Holding a kick-off meeting at beginning of project is not sufficient; and increasing PMO involvement and test automation do not address customer satisfaction issue.\nEssential Scrum: A Practical Guide to the Most Popular Agile Process (No Date) Kenneth S. Rubin//21/ [Item]"
  },
  {
    "id": "43 of 175",
    "question": "A project manager is beginning a new project and is starting to form the project team. The project manager has not worked with anyone from this team previously, and most of the team members do not know each other, and some are located in different countries.\nWhich two actions should the project manager take to help the team work more closely together? (Choose two)",
    "options": {
  ...
  },
  {
    ...
    "answer": "C",
    "explanation": "Demos or reviews is a part of every agile sprint that helps the product owner or customer to gain visibility on the development progress and provide feedback that facilities the team to make appropriate changes early in the project. Hence this option is the correct answer.\nExpert judgement, decision making and checklists are techniques that are generally a part of predictive project management approaches and hence is irrelevant in this scenario. As a result, these options are incorrect.\nO'Reilly Platform (No Date) //Chapter 3 Business Practices/ [Item Clean Agile: Back to Basics]\n| The Agile Practice Guide (No Date) PMI/PMI/5.2.5/55 [Item Demostration/reviews]"
  },
  {
    "id": "48 of 175",
    "question": "The project manager of a software development project for a financial institution realizes that team members are unusually delayed on their assigned tasks. The project manager has not experienced this before on previous, similar projects. After further investigation, the project manager determined that the delays were linked to the recent resignation of an experienced team member.\nWhat should the project manager have done to avoid this situation?",
    "options": {
  ...
  {
    "id": "55 of 175",
    "question": "While working on a long project with many changes, a project manager is informed by a team member that some users are uncomfortable with certain product functionalities released in the previous iteration.\nWhich action should the project manager take?",
    "options": {
  ...
  {
    "id": "57 of 175",
    "question": "A project manager is assigned to take over an ongoing project. During the quality review, the team discovered that 40% of the deliverables have defects and require rework, with an expected worsening trend.\nWhat should the project manager's first step be?",
    "options": {
  ...
  {
    "id": "58 of 175",
    "question": "An external stakeholder has a significant impact on the project, as they have the ability to approve or reject changes to the project scope, timeline, and budget. What approach should the project manager take with this stakeholder?",
    "options": {
  ...
  {
    "id": "60 of 175",
    "question": "A project team, distributed across three different countries, is having a difficult time arranging meetings. The team members are also unclear about the project requirements and are having trouble getting their questions answered.\nWhat should be done to increase project success?",
    "options": {
  ...
  },
  {
    ...
    "options": {
      ...
      "D": "Implemented strict control measures to ensure that project s and deliverables are met."
    },
    "answer": "C",
  ...
  {
    "id": "64 of 175",
    "question": "A large transformation project has moved its project management office (PMO) to a virtual environment. There have been performance issues with the PMO team regarding the daily tasks they perform, which are now affecting the project.\nWhich three actions should the project manager take to improve the performance of the PMO team? (Choose three)",
    "options": {
  ...
  {
    "id": "70 of 175",
    "question": "Team members are transferred from a predictive project to a newly formed agile team. The new team members are expressing dissatisfaction about the additional training they are required to complete in the internal project team chat channel. How should the project manager address this situation?",
    "options": {
  ...
  {
    "id": "71 of 175",
    "question": "Some of the project's materials have been ordered from overseas. The supplier notifies the project team that the materials will not reach the site on time due to a customs clearance delay that will affect the critical path.",
    "options": {
  ...
  {
    "id": "78 of 175",
    "question": "During a daily standup, some team members realized they were not all prioritizing the requirements in the same way. This could impact the current iteration's goals.\nWhat should the project manager do to resolve this issue?",
    "options": {
  ...
  {
    "id": "80 of 175",
    "question": "A project manager oversees an agile project with an experienced project team. The project manager does not typically attend the daily stand-up meetings, but they sit in on them from time to time. After attending one particular meeting, the project manager noticed that the meeting was not productive.\nWhat should the project manager do to improve the situation?",
    "options": {
  ...
  {
    "id": "85 of 175",
    "question": "A member of a development project team informs the project manager that the operating system is not going to be installed on time due to a late upgrade by the supplier. What should the project manager do first?",
    "options": {
    ...
    "answer": "A",
    "explanation": "The project manager must quantify an impact in order to understand the adjustments needed in the project in terms of schedule, budget, and/or resources. Only after the impact is assessed can the project manager implement the appropriate responses to maintain optimal performance.\nThe other answers may occur after this appraisal exercise.\nPMBOK Guide Sixth Edition (2018) PMI/PMI/3.4/60 [Item]\n| Project Risk Management: A Practical Implementation Approach (No Date) Michael M. Bissonette//4: Classical Project Risk Mgmt Practices/ [Item Planning Risk Mgmt]"
  },
  {
    "id": "86 of 175",
  ...
  {
    "id": "89 of 175",
    "question": "A project manager has been assigned to an existing agile team and is preparing for an upcoming project. The last project that the team worked on was so successful that a senior stakeholder requested that the team use the same governance structure for the new project.",
    "options": {
  ...
  {
    "id": "92 of 175",
    "question": "A newly launched product prototype is receiving a number of customer complaints. To reduce negative feedback, the team comes up with an action plan. At the end of the quarter, however, the project manager found there was no significant reduction in complaints.",
    "options": {
  ...
  {
    "id": "94 of 175",
    "question": "A project can gain downstream marketing benefits if additional equipment is included in the project scope. However, this equipment is still in an early development phase and will not be ready to meet the project timelines. A member of the project steering committee is in favor of its inclusion.",
    "options": {
  ...
  {
    "id": "96 of 175",
    "question": "Critical project equipment is being produced by an overseas vendor. A quality survey revealed noncompliance with some of the project specifications.",
    "options": {
  ...
  },
  {
    ...
    "options": {
      ...
      "D": "Engage with the product owner to facilitate fast-tracking of the transition."
    },
    "answer": "A",
  ...
  {
    "id": "100 of 175",
    "question": "An oil refinery project is in the middle of the execution phase. The project team found that the project is delayed because of an environmental regulation change, procurement delays, and a change in government. However, the project deliverable is still urgently needed.",
    "options": {
    ...
    "answer": "B",
    "explanation": "Any regulatory requirements or changes to requirements must be reviewed and aligned with the new regulations. By reviewing the impact of the changes, complying with the new regulations, and proposing a realistic plan, the project manager can increase the chances of success and minimize the impact of the delays.\nThe other options are too risky, drastic, or premature.\nO'Reilly Platform (No Date) //3/Identifying project scope risk [Item Identifying and Managing Project Risks 3rded]\n| PMBOK Guide Sixth Edition (2018) PMI/PMI/8/276 [Item]"
  },
  {
    "id": "101 of 175",
  ...
  {
    "id": "103 of 175",
    "question": "An extremely talented and results-oriented team member is suddenly struggling with a personal problem. Due to this, there is a change in the team member's behavior, and it starts to affect the project deliverables as well as the morale of other team members.",
    "options": {
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "The project team's ground rules, which state that the project manager should receive all communication, had been agreed upon beforehand, so the best action for the project manager to take is to personally remind the team member who violated a ground rule. Effective and efficient engagement and communication include determining how, when, how often, and under what circumstances stakeholders want to be—and should be—engaged.\nO'Reilly Platform (No Date) //10/ [Item The Unwritten Rules of Managing Up by Dana Brownlee Chapter 10, section \"Develop Team Ground Rules\"]"
  },
  {
    "id": "112 of 175",
    "question": "During project execution, a project manager is informed that some resources will soon be removed from the project. What should the project manager do to address this situation?",
    "options": {
      "A": "Schedule an urgent meeting to keep stakeholders informed.",
      "B": "Inform the stakeholders during the next scheduled review meeting.",
      "C": "Update the risk register with this urgent risk to the project.",
      "D": "Determine which resources are essential and request resource leveling."
    },
    "answer": "D",
    "explanation": "Identifying essential resources helps focus efforts on retaining those that are crucial for the project's success. Resource leveling is the process of adjusting the project schedule to ensure that resources are available when needed and that resource utilization is optimized. When resources are removed from a project, resource leveling can help the project manager identify alternative resources or adjust the project schedule to minimize the impact on the project. By requesting resource leveling, the project manager can proactively address the situation and ensure that the project stays on track and aligned with the organization's goals. After this, the project manager will gain a clearer understanding of the impact and will be able to determine the next steps and mitigate potential disruptions.\nThe other answer choices are not as relevant or effective.\nKeeping stakeholders informed and updating the risk register are important actions, but determining essential resources and requesting resource leveling directly addresses the immediate challenge and provides the necessary information needed to carry out subsequent actions. Scheduling a meeting or waiting until the next scheduled review meeting to inform stakeholders may not be necessary and could delay the project or cause confusion. Updating the risk register may be premature without more information and does not directly address the issue of resource availability.\n| PMBOK Guide Sixth Edition (2018) PMI/PMI//362 [Item]"
  },
  {
    "id": "113 of 175",
    "question": "A project team is in sprint thirteen of a fourteen-sprint project. The project team placed a game-changing feature on the backlog for the next release. The product owner is informed that a competitor is launching a new product with a feature that closely resembles the feature placed on the backlog. The product owner is demanding that this feature be incorporated into the current release.",
    "options": {
      "A": "Organize a review meeting with the development team to understand the extent of work required.",
  ...
  {
    "id": "118 of 175",
    "question": "A project manager was recently assigned to an investigation project. Due to the complexity of the project, the project manager is unsure if any regulation applies.\nHow should the project manager determine which regulations apply to the project?",
    "options": {
  ...
  {
    "id": "121 of 175",
    "question": "A new project manager joins an organization that has never had formal project management processes. Some team members refuse to participate in basic tasks such as taking ownership of action items at meetings.",
    "options": {
  ...
  {
    "id": "123 of 175",
    "question": "A team member with sufficient experience and knowledge informs the project manager about a conflict with another team member and asks for advice and assistance. The project manager schedules a meeting to discuss the conflict with the team members involved.\nWhat should the project manager do during the meeting to resolve the conflict?",
    "options": {
  ...
  {
    "id": "127 of 175",
    "question": "A customer is performing a weekly visit to a project site to inspect the final stage of product development. The quality manager alerts the project manager that the customer has been very unprofessional and reprimanded the team members during previous weekly visits.\nWhat should the project manager do to address this incident?",
    "options": {
    ...
    "answer": "D",
    "explanation": "The project manager should attempt to resolve the conflict by defining the problem, collecting facts, analyzing the situation, and selecting the most appropriate course of action.\nThe other answer choices are incorrect because they are reactions to an issue that may not be fully understood without the input of the team and the client.\nPMBOK Guide Sixth Edition (2018) PMI/PMI/9.5.2.1/348 [Item]\n| Project Managers Portable HandBook, 3rd Ed (No Date) //5.4.6/ [Item 5.4.6 - Conflict resolution modes - Problem solving]"
  },
  {
    "id": "128 of 175",
    "question": "One day before starting a task, the technical lead proposed a new implementation approach that could reduce the schedule by one week. However, if the approach does not work, the task will be delayed by three days.",
    "options": {
  ...
  {
    "id": "131 of 175",
    "question": "A project manager is working on a deployment project to replace some equipment that will soon become obsolete. A review of the schedule and cost has revealed that a 5-month delay is likely.\nHow should the project manager address risks from the delay?",
    "options": {
  ...
  {
    "id": "134 of 175",
    "question": "In an ongoing project, performance is continuously evaluated to determine benefits. Which two actions should the project manager do at the beginning of the project? (Choose two)",
    "options": {
  ...
  {
    "id": "138 of 175",
    "question": "During sprint planning, an agile team and product owner identified that the team should be able to finish five user stories. However, during the sprint, the team worked on more than five stories but did not complete any stories at all.",
    "options": {
  ...
  },
  {
    ...
    "answer": "D",
    "explanation": "Agile times thrive with servant leadership. Servant leadership is a style of leadership that focuses on understanding and addressing the needs and development of project team members in order to enable the highest possible project team performance. A critical role for the servant leader is to maximize delivery by removing impediments to their progress. This includes solving problems and removing obstacles that may be hampering the project team’s work. By solving or easing these impediments, the project team can deliver value to the business faster.\nThe other options are incorrect because they do not align with the principles of servant leadership.\nO'Reilly Platform (No Date) //2. Characteristics of Service Leader/ [Item Servant Leadership in Action]\n| The Agile Practice Guide (No Date) PMI/PMI/4/33-35 [Item]"
  },
  {
    "id": "140 of 175",
    "question": "A project team is unexpectedly audited. Several nonconformances were identified during the audit. Which three actions could the project manager have taken to prevent this situation? (Choose three)",
    "options": {
  ...
  {
    "id": "154 of 175",
    "question": "A project manager works in a matrix organization. Following a reorganization, several key project resources are reassigned to another project. The project no longer has the resources needed to successfully deliver the project.",
    "options": {
  ...
  {
    "id": "156 of 175",
    "question": "A company has hired a project manager to implement an adaptive project framework. The project has made some progress, but the team is frustrated because the client does not provide feedback or participate in defining acceptance criteria.\nWhat could have caused this situation?",
    "options": {
  ...
  {
    "id": "161 of 175",
    "question": "A project manager is working on a global project with team members in several different countries. To manage communications, the project manager plans to hold virtual meetings and on-site visits once a month.\nWhat should the project manager do next while working with this team?",
    "options": {
  ...
  {
    "id": "165 of 175",
    "question": "On an agile project, a team member has been taking smaller, easier user stories from the backlog, not those with the highest priority. How should this be addressed?",
    "options": {
  ...
  {
    "id": "167 of 175",
    "question": "A virtual team is midway through a sprint on a complex task and is ahead of schedule. During the daily coordination meeting, a new team member interrupts and asks everyone to describe what they worked on prior to the current sprint.",
    "options": {
      "A": "Thank the new team member for their interest and direct them to the project management plan.",
      "B": "Explain that the daily coordination meeting is not the best time for this discussion.",
      "C": "Instruct the new team member to leave the daily coordination meeting because they are interrupting.",
      "D": "Ask all team members to list the tasks they completed prior to the current sprint."
    },
    "answer": "B",
    "explanation": "To ensure that the daily coordination meeting is productive and efficient, the project manager should be polite and understanding and explain to the new team member that the daily coordination meeting is not the best time for this discussion. After the meeting, the project manager can later schedule a time to discuss the new team member's role, all prior work, and help the new team member get up to speed on the project.\nThe other answer choices are incorrect. Thanking the new team member and directing them to the project documentation is not helpful if they are not familiar with the documentation, and the project management plan is not the best resource in this instance. Requesting the new team member to leave the meeting for interrupting the daily coordination meeting is too harsh and could damage team morale. Asking all team members to list their completed tasks prior to the current sprint would take up valuable time during the daily coordination meeting.\nInformation Technology Project Management, 7th Ed. (2015) Kathy Schwalbe/Course Technology//68 [Item]\n| The Agile Practice Guide (No Date) PMI/PMI//54 [Item]"
  },
  {
    "id": "168 of 175",
    "question": "A project manager is leading a new implementation project with a global project team. As team members are in different geographical locations and time zones, the project manager has to decide on the most effective team engagement strategy.\nWhat is the first action the project manager should take?",
    "options": {
  ...
  {
    "id": "171 of 175",
    "question": "During the execution phase of a project, the project manager is reassigned to another project. A new project manager takes over and quickly realizes that the project is facing issues with the quality and scheduling of some deliverables.\nWhich of the following should the new project manager do first?",
    "options": {
  ...
  },
  {
    ...
    "answer": "A",
    "explanation": "It is very important that the team understands the advantages of moving to an iterative approach from the existing predictive approach. Scheduling a workshop with the team to plan the upcoming iterations is the best way to ensure a smooth transition between approaches.\nAll other options do not help with the transition between approaches. The activities are appropriate but not at this time of transition.\nO'Reilly Platform (No Date) //11/166 [Item Book: Choose your WoW]\n| The Agile Practice Guide (No Date) PMI/PMI/5/58 [Item Table 5.1]"
  },
  {
    "id": "173 of 175",
  ...
  {
    "id": "175 of 175",
    "question": "A company is creating a new application for its users. The agile team completed the initiating stage and is performing iterations to complete planning and execution. However, a stakeholder wants to change the order of the deliverables to demonstrate new aspects of the app to stakeholders.",
    "options": {
